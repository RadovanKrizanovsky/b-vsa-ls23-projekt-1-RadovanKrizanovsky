...
public class TestUtils {
  ...
  public static Object getFieldValue(Object obj, String field)
    ...
    if (fields.isEmpty()) throw new NoSuchFieldException(
      "Cannot find field with name '" +
      field +
      "' on class '" +
    ...
    if (getter.getParameterCount() != 0) throw new NoSuchMethodException(
      "Retrieved method 'get" +
      capitalize(fields.get(0)) +
      "' does not have 0 arguments so it cannot be safely invoked"
    );
  ...
  public static <T> T getFieldValue(
    ...
    if (getter.getReturnType() != fieldType) throw new NoSuchMethodException(
      "Retrieved method 'get" +
      capitalize(fields.get(0)) +
      "' does not have provided return type " +
      fieldType.getName()
    );
    return fieldType.cast(getter.invoke(obj));
  }

  public static Object setFieldValue(Object obj, String field, Object newValue)
    throws NoSuchMethodException, InvocationTargetException, IllegalAccessException {
    Method setter = obj
      .getClass()
      .getMethod("set" + capitalize(field), newValue.getClass());
    if (
      setter.getParameterCount() != 1 ||
      setter.getParameterTypes()[0] != newValue.getClass()
    ) throw new NoSuchMethodException(
      "Retrieved method 'set" +
      capitalize(field) +
      "' does not have 1 argument of type '" +
      newValue.getClass() +
      "' so it cannot be safely invoked"
    );
  ...
  public static List<String> findField(
    Object obj,
    String fieldName,
    boolean exactMatch
  ) {
  ...
  public static <T> List<String> findField(
    Object obj,
    String fieldName,
    Class<T> fieldType
  ) {
  ...
  public static <T> boolean checkIfMethodIsGetter(
    Method method,
    String fieldName,
    Class<T> fieldType,
    boolean exactMatch
  ...
  public static Long getEntityId(Object obj, String idFieldName)
    throws InvocationTargetException, NoSuchMethodException, IllegalAccessException, NoSuchFieldException {
    if (idFieldName == null) {
      idFieldName = "id";
    }
    ...
    if (fields != null && !fields.isEmpty()) {
      if (fields.size() > 1) log.warn(
        "More than one potential id field find on object of class " +
        obj.getClass().getName()
      );
  ...
  public static Long getEntityId(Object obj)
    ...
    Field idField = Arrays
      ...
      .filter(f ->
        f.isAnnotationPresent(Id.class) && f.getType().equals(Long.class)
      )
      .findAny()
      .orElse(null);
  ...
  public static String findIdFieldOfEntityClass(
    List<String> potentialIdFields,
    Class entityClass
  ) {
    return potentialIdFields
      .stream()
      .map(idField -> {
        try {
      ...
      .orElseThrow(() ->
        new IllegalStateException(
          "Cannot find id field of Long type for entity class " +
  ...
  public static String findIdFieldOfEntityClass(Class entityClass) {
    return Arrays
      ...
      .filter(f ->
        Arrays
          .stream(entityClass.getMethods())
          .anyMatch(m ->
            checkIfMethodIsGetter(m, f.getName(), f.getType(), true)
          )
      )
      .map(Field::getName)
      .distinct()
  ...
  public static AbstractThesisService<?, ?, ?> getServiceClass() {
    ...
    Set<Class<?>> cps = reflections.get(
      SubTypes.of(AbstractThesisService.class).asClass()
    );
  ...
  public static Class<?> getEntityClassFromService(
    Class<AbstractThesisService<?, ?, ?>> serviceClass,
    int parameterOrder
  ) {
    return (Class<?>) (
      (ParameterizedType) serviceClass.getGenericSuperclass()
    ).getActualTypeArguments()[parameterOrder];
  }
  ...
  public static void runSQLStatement(
    ...
    try (Statement stmt = con.createStatement()) {
      ...
      if (!silent) log.error(ex.getMessage(), ex);
    }
  }
  ...
  public static <T> T getTestClassFieldValues(
    Class<?> testClass,
    String field,
    Class<T> fieldValueType
  ...
  public static Object createTeacher(
    AbstractThesisService<Object, Object, Object> service,
    Class testClass
  ) throws NoSuchFieldException, IllegalAccessException {
  ...
  public static Object createThesis(
    AbstractThesisService<Object, Object, Object> service,
    Class testClass,
    Long teacherId
  ) throws NoSuchFieldException, IllegalAccessException {
